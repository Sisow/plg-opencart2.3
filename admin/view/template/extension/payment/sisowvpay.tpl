...
<div id="content">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ppexpress" class="form-horizontal">
		<div class="form-group required">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_merchantid" value="<?php echo $sisowvpay_merchantid; ?>" id="entry_merchantid" class="form-control" maxlength="32" size = "32"/>
		...
		<div class="form-group required">
			...
			<div class="col-sm-4">
				<input type="text" name="sisowvpay_merchantkey" value="<?php echo $sisowvpay_merchantkey; ?>" id="entry_merchantkey" class="form-control" maxlength="64" size = "64"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_shopid" value="<?php echo $sisowvpay_shopid; ?>" id="entry_shopid" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select name="sisowvpay_status_success" id="entry_success" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_paymentfee" value="<?php echo $sisowvpay_paymentfee; ?>" id="entry_paymentfee" class="form-control" maxlength="8" size = "8"/>
			</div>
		</div>
		
		<div class="form-group">
			<label class="col-sm-2 control-label" for="entry_sisowvpay_fee_tax"><?php echo $entry_sisow_fee_tax; ?></label>
			<div class="col-sm-2">
				<select name="sisowvpay_fee_tax" id="entry_sisowvpay_fee_tax" class="form-control">
					<option value=""><?php echo $text_none; ?></option>
					<?php foreach ($tax_classes as $tax_class) { ?>
					<?php if ($tax_class['tax_class_id'] == $sisowvpay_fee_tax) { ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvpay_testmode" id="entry_testmode" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_total" value="<?php echo $sisowvpay_total; ?>" id="entry_total" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_totalmax" value="<?php echo $sisowvpay_totalmax; ?>" id="entry_totalmax" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvpay_geo_zone_id" id="entry_geo_zone" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
					<select name="sisowvpay_status" id="entry_status" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" name="sisowvpay_sort_order" value="<?php echo $sisowvpay_sort_order; ?>" id="entry_sort_order" class="form-control" maxlength="8" size = "8"/>
				<?php if (isset($error['username'])) { ?>
				<div class="text-danger"><?php echo $error['username']; ?></div>
				<?php } ?>
			</div>
