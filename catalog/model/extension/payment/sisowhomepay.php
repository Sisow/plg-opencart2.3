...
class ModelExtensionPaymentSisowHomepay extends Model {
	public function getMethod($address = false, $total = false) {
		...
		$this->load->language('extension/payment/sisowhomepay');
		$data = array(
			'code'		=> 'sisowhomepay',
			'title'		=> $this->language->get('text_title').($this->config->get('sisowhomepay_testmode') == 'true' ? ' [Testmode]' : ''),
			'terms'      => '',
